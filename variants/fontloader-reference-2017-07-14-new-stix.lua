-- merged file : D:/context-minimals/context/tex/texmf-context/tex/generic/context/luatex/luatex-fonts-merged.lua
-- parent file : D:/context-minimals/context/tex/texmf-context/tex/generic/context/luatex/luatex-fonts.lua
-- merge date  : Fri Jul 14 16:45:02 2017
-- UF: + contains experimental font-oto.lua (stix2bug)
-- UF
texio.write_nl ("------------------")
texio.write_nl ("!!!!! UF: this fontloader uses an experimental font-oto.lua")
texio.write_nl ("!!!!! UF: This fontloader need the luaotfload-letterspace 2017-07-14 !!!!!")
texio.write_nl ("------------------")
-- /UF
